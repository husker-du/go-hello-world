...
resource "aws_autoscaling_policy" "custom_cpu_scale_up" {
  name                   = "custom-cpu-metrics-scale-up-policy-${terraform.workspace}"
...
resource "aws_cloudwatch_metric_alarm" "custom_cpu_scale_up" {
  alarm_name          = "custom-cpu-metrics-scale-up-alarm-${terraform.workspace}"
...
resource "aws_autoscaling_policy" "custom_cpu_scale_down" {
  name                   = "custom-cpu-metrics-scale-down-policy-${terraform.workspace}"
  autoscaling_group_name = var.autoscaling_group_name
  adjustment_type        = "ChangeInCapacity"
...
resource "aws_cloudwatch_metric_alarm" "custom_cpu_scale_down" {
  alarm_name          = "custom-cpu-metrics-scale-down-alarm-${terraform.workspace}"
